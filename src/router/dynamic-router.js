...
/*鼠标滚轮控制页面大小缩放 */
const WheelScale = () => import(/* webpackChunkName: 'WheelScale' */ '@/views/wheelScale/index.vue')
...
const dynamicRoutes = [
  ...
  { path: '/wheelScale', name: 'WheelScale', component: WheelScale, meta: { name: 'WheelScale', icon: 'el-icon-s-platform' } }
];
