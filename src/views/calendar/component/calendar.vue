...
<template>
  <section class="wh_container calendar_box_self">
    <div class="wh_content_all">
      ...
      <div class="wh_content">
        ...
        >
        <!-- 具体日期 -->
        <el-tooltip :content="'日期' + item.id" effect="light" placement="top" class="tooltip_box" popper-class="tooltip_box_a" :hide-after="4000">
          <div
            class="wh_item_date"
            v-bind:class="[
